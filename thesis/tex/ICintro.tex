...
via the $Z$), a fermion (which is not another neutrino) exits with altered properties. This fermion is then directly or indirectly detected, 
...
a charged lepton by its emitted Cherenkov light, produced from its travel through the ice. 
In the case of CC interactions, this charged lepton is directly involved in the interaction with the neutrino, either as 
both incoming and outgoing particles, or as only the outgoing particle in the case of a hadronic CC interaction.
