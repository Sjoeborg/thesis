...
% equal. 
% First, the difference in the density profiles introduces wildly different matter effects. 
...
\begin{figure}\label{fig:events}
    ...
    \end{center}
\end{figure}
% TODO: Write down CC NC equations after 1st paragraph, using N and N’ (N’ can be shower etc).
...
information in Table~\ref{table:events}, containing classifications from `Sample B' of a 2019 DeepCore study~\cite{DC2019tauappearance}.
