...
% TODO Ch 5.1 write that we didn’t include deep core because resonance doesn’t appear there (in footnote). Refer to figures that show that resonance in TeV. We bring Deepcore back in the next section. 
...
%Thus, we expect the best fitting 
...
remains fixed. %We put $f=35\%$ and compare our results to the Giunti et al.~\cite{gariazzoUpdatedGlobalAnalysis2017} in Fig.~\ref{fig:s24_contour}. %TODO fix
...
%    %and the result from~\cite{gariazzoUpdatedGlobalAnalysis2017}
%    }\label{fig:s24_contour}    
%\end{figure} %TODO fix
...
\begin{figure}
    %TODO: Fig 5.3 mention what is written in the legend. 
    \centering
...
\end{figure}
%TODO: Mention that we see from this that the simulations are consistent with 3+0 with deviations in 6%. Fix label sizes. 
% Include figure on theta34 and say that IC can’t distinguish it.
%\end{document}