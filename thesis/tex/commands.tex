...
\usepackage{physics,amsmath, amsfonts, siunitx, amssymb, graphicx, slashed,subcaption,lipsum,transparent,pdfpages}
\usepackage[utf8]{inputenc}
\usepackage{setspace}
\setstretch{1.1}
\usepackage[margin=1.2in, top = 1.3in, bottom = 1.3in]{geometry}
%\usepackage{xr-hyper}
\usepackage[hidelinks, pdftex, pdfauthor={Martin Sj\"oborg},
pdftitle={Sterile Neutrinos and Non-Standard Interactions
in Neutrino Telescopes}]{hyperref}
\newcommand{\n}[1]{\nu_{#1}}
\newcommand{\na}{\nu_\alpha}
\newcommand{\nb}{\nu_\beta}
\newcommand{\ana}{\bar{\nu}_\alpha}
