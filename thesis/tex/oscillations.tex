...
\begin{pmatrix}c_{12} & s_{12} & 0 \\ -s_{12} & c_{12} & 0 \\ 0 & 0 & 1\end{pmatrix} \nonumber \\
 &=\begin{pmatrix}c_{12} c_{13} & s_{12} c_{13} & s_{13} e^{-i \delta_{\mathrm{CP}}} \\ 
    ...
    \end{pmatrix}\,,
\end{align}
where $s_{ij} = \sin(\theta_{ij})$, $c_{ij} = \cos(\theta_{ij})$, $0 \leq \theta_{ij} \leq \pi/2$ and $ 0 \leq \delta_\mathrm{CP} \leq 2\pi$
...
leaving only one physical phase for us to measure. We are now down to four degrees of freedom in the three dimensional case: three angles
...
of the form $s_{ij}, c_{ij}$, and one phase of the form $e^{i\delta}$. The angle $\theta_{ij}$ specifies the amount of rotation in the $i-j$ plane, allowing an $i$ eigenstate to mix with a $j$ eigenstate. The physical interpretation of
