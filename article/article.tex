...
\usepackage{hyperref}
\begin{document}
\section{Formalism of non-standard interactions}\label{sec:intro} %OK
...
\subsection{NSI phenomenology at probability level}\label{sec:nsiProbEffects} %OK
...
\begin{figure}% TODO: check if this is redundant
