...
\end{figure}%TODO: fix cbar need high emt and log to show both cascade and track features at the same time.
...
\begin{figure}
   \begin{center}
      ...
      IceCube tracks only reveal $\emt$, and are displayed separately.}\label{fig:joint_3D}
   \end{center}
\end{figure} 
\begin{figure}
   \begin{center} 
...
\begin{table}
   \begin{tabular}{lcccc}
      ...
      \hline
   \end{tabular}
   \caption{PINGU and joint results from the $\Delta \chi^2$ in Fig.~\ref{fig:3D_NO}. PINGU best and worst cases refer to 
