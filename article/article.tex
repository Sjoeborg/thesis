...
production height of 15 km and an Earth radius of 6371 km. %TODO: add more here?
...
%TODO: table with individual and combined chisq values. Discussion on impact of IC on chisq.
...
\begin{table}
   ...
   \begin{tabular}{lcccc}
           ...
           \cline { 2 - 4 } Parameter & $\dm$ & $\theta_{23}$  & $\epsilon$ & 90\% CL of $\epsilon$ \\
           \hline
           $\ett$ &-& - & - & -\\
           $\emt$ &0.002435& 0.76736 & -0.005 & -0.015, 0.005\\
           $\eem$ &-& - & - & -\\
           $\eet$ &0.002435 & 0.7673630944601736 & 0.05 & -0.072, 0.138\\
           \hline
       \label{table:results}
   \end{tabular}
   \end{center}
   \caption{DeepCore results}
\end{table}
...
\begin{table}
   ...
   \begin{tabular}{lcccc}
           ...
           $\emt$ &-& - & - & -\\
           $\eem$ &-& - & - & -\\
           $\eet$ &0.002517 & 0.8587019919812102 & 0.05 & -0.105, 0.101\\
           \hline
       \label{table:results}
   \end{tabular}
   \end{center}
