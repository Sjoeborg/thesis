...
\tikzset{%
       ...
       mbrace/.style = { decorate, decoration={brace, amplitude=5pt, mirror} },
        label/.style = { black, midway, scale=.7, align=center },
...
\newcommand\particle[7][white]{%
  \begin{tikzpicture}[x=1cm, y=1cm]
    ...
    \ifstrempty{#2}{}{\node at(0.45,-0.55)  [nosep,anchor=mid,scale=1.5] {#2};}
  \end{tikzpicture}
}
...
\begin{tikzpicture}[x=1.2cm, y=1.2cm]
  ...
  \node at(0, 0)   {\particle%[gray!20!white]
                   {$u$}        {}       {$2.3$ MeV}{1/2}{$2/3$}{R/G/B}};
  \node at(0,-1)   {\particle%[gray!20!white]
                   {$d$}        {}    {$4.8$ MeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(0,-2)   {\particle%[gray!20!white]
                   {$e$}        {}       {$511$ keV}{1/2}{$-1$}{}};
  \node at(0,-3)   {\particle%[gray!20!white]
                   {$\nu_e$}    {}         {$<2$ eV}{1/2}{}{}};
  \node at(1, 0)   {\particle
                   {$c$}        {}   {$1.28$ GeV}{1/2}{$2/3$}{R/G/B}};
  \node at(1,-1)   {\particle 
                   {$s$}        {}  {$95$ MeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(1,-2)   {\particle
                   {$\mu$}      {}         {$105.7$ MeV}{1/2}{$-1$}{}};
  \node at(1,-3)   {\particle
                   {$\nu_\mu$}  {}    {$<190$ keV}{1/2}{}{}};
  \node at(2, 0)   {\particle
                   {$t$}        {}    {$173.2$ GeV}{1/2}{$2/3$}{R/G/B}};
  \node at(2,-1)   {\particle
                   {$b$}        {}  {$4.7$ GeV}{1/2}{$-1/3$}{R/G/B}};
  \node at(2,-2)   {\particle
                   {$\tau$}     {}          {$1.777$ GeV}{1/2}{$-1$}{}};
  \node at(2,-3)   {\particle
                   {$\nu_\tau$} {}  {$<18.2$ MeV}{1/2}{}{}};
  ...
  \node at(4,-3)   {\particle[orange!20!white]
                   {$W^{\hspace{-.3ex}\scalebox{.5}{$\pm$}}$}
                                {}              {$80.4$ GeV}{1}{$\pm1$}{}};
  \node at(5,-3)   {\particle[orange!20!white]
                   {$Z$}        {}                    {$91.2$ GeV}{1}{}{}};
  \node at(4.5,-2) {\particle[green!50!black!20]
                   {$\gamma$}   {}                        {}{1}{}{}};
  \node at(4.5,-1) {\particle[purple!20!white]
                   {$g$}        {}                    {}{1}{}{color}};
  \node at(6,0)    {\particle[gray!50!white]
                   {$H$}        {}              {$125.1$ GeV}{0}{}{}};
...
\draw [<-] (2.5,-0.3)  -- (2.7,-0.3)         node [legend]   {spin};
  ...
  \draw [mbrace] (-0.8,0.5)  -- (-0.8,-1.5)
                 node[leftlabel] {6 quarks};
  \draw [mbrace] (-0.8,-1.5) -- (-0.8,-3.5)
                 node[leftlabel] {7 leptons};
  \draw [mbrace] (-0.5,-3.6) -- (3.5,-3.6)
                 node[bottomlabel]
                 {13 fermions};
  \draw [mbrace] (3.5,-3.6) -- (6.5,-3.6)
                 node[bottomlabel] {6 bosons};

% \draw [brace] (-0.5,.8) -- (2.5,.8) node[toplabel]         {matter};
%   \draw [brace] (2.5,.8)  -- (4.5,.8) node[toplabel]       {gauge bosons};
%   \draw [brace] (4.5,.8)  -- (5.5,.8) node[toplabel]       {scalar\\bosons};
